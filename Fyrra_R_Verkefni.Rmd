...
ia) Hverjar eru líkurnar á að ein eignin sé einbýlishús?
ef það má bara vera ein og ekki fleiri
```{r}
dbinom(1,3,0.2)
```
ib) Hverjar eru líkurnar á að ein eignin sé einbýlishús?
ef það mega vera fleiri en ein
```{r}
1-pbinom(0,3,0.2)
```
